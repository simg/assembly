...
create table public.comment (
  ...
  thread_id bigint references public.comment(id) on delete cascade,
...
create trigger tr_increment_comment_relation_count after insert on public.comment for each row execute procedure increment_comment_relation_count();
create trigger tr_decrement_comment_relattion_count after delete on public.comment for each row execute procedure decrement_comment_relation_count();
