...
exports.stripAscii = exports.serializeParameters = exports.formatFailure = exports.BaseReporter = void 0;
...
function formatTestHeader(config, test, indent, index) {
    ...
    if (Object.keys(test.parameters).length)
        tokens.push(indent + (index ? ' '.repeat(String(index).length + 2) : '') + safe_1.default.gray(serializeParameters(test.parameters)));
    return tokens.join('\n');
}
