...
export declare let fixturePool: FixturePool;
export declare class WorkerRunner extends EventEmitter {
    ...
    private _runTestWithFixturesAndHooks;
    private _tearDownTestScope;
    private _runHooks;
